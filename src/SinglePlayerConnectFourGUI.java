 ...
 */
public class SinglePlayerConnectFourGUI extends JFrame implements ActionListener {
     ...
     */
    public SinglePlayerConnectFourGUI(String title) throws HeadlessException {
        super(title);
